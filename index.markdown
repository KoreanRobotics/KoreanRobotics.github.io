      ...
      <ul class="seminar-list" aria-live="polite">
        ...
        <li class="seminar-item">
          ...
          <div>
            ...
            <div class="seminar-presenters">Presenters: W. Jung (Industry Liaison), Panel of Guests</div>
          </div>
        </li>
        <!-- END EXAMPLES -->
      </ul>
    ...
    <section id="organizers" aria-labelledby="organizers-heading">
      ...
      <div class="organizers-grid" role="list">
        ...
        <div class="organizer" role="listitem">
          ...
          <p><a href="https://example.com/choi">Wonsuhk Jung</a><br><span class="muted">Industry Liaison · Ph.D. Student, Georgia Tech</span></p>
        </div>
        <div class="organizer" role="listitem">
