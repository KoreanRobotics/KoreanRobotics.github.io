...
발표자: Gihyeok Na (PhD Student, University of Illinois at Urbana-Champaign)
발표 제목: Design of High-Power Underactuated Monopedal Hopping Robots

KARA 제29회 정기 세미나
일자: 4월 30일 (목)
시간: 8:00PM-9:30PM ET (7:00PM-8:30PM CT, 5:00PM-6:30PM PT)
발표자: Dong Ho Kang (PhD Student, University of Texas at Austin)
발표 제목: Shaping Dexterity Through Hardware: Contact Morphology, Compliance, and Mechanism Design
Abstract: Robotic manipulation is often framed as a problem of planning, perception, or control. However, the physical design of the robot itself fundamentally shapes what kinds of manipulation are possible, robust, and learnable. The core question focuses on how hardware design can be used as an active ingredient in manipulation, rather than a passive platform for algorithms.
...
📢 안녕하세요, KARA 제25회 정기 세미나를 안내드립니다!
이번 세미나는 논문 투고에 대하여 토론하는 자리를 마련했습니다.
논문 투고를 준비하시는 분, 투고 경험을 나누고 싶은신 분, 같이 모여서 이야기를 나누어 보아요! 😆
[25th KARA Research Seminar]
- 일자: 3월 5일 (목)
- 시간: 8:00 PM (ET) / 7:00 PM (CT) / 5:00 PM (PT)



📢 KARA 제24회 정기 세미나를 안내드립니다!
많은 관심과 참여 부탁드립니다! 😆 
[24th KARA Research Seminar]
- 일자: 2월 19일 (목)
- 시간: 8:00 PM (ET) / 7:00 PM (CT) / 5:00 PM (PT)
- 연사: yunsoo seo (PhD Student @ UT Austin)
- 제목: Reinforcement learning referenced whole body MPPI for humanoid walking control
- 참여링크: https://lnkd.in/enEf4m6u
Abstract:
...
📢 KARA 제23회 정기 세미나를 안내드립니다!
많은 관심과 참여 부탁드립니다!
[23rd KARA Research Seminar]
- 일자: 2월 5일 (목)
- 시간: 8:00 PM (ET) / 7:00 PM (CT) / 5:00 PM (PT)
- 연사: Minhyuk Jang (PhD Student @ UIUC)
- 제목: Are you confident your sensor is tuned correctly? Robust Kalman filtering under noise uncertainty
- 참여링크: https://lnkd.in/enEf4m6u
[Abstract]
...
📢안녕하세요, 모두 겨울방학 즐겁게 보내셨나요! 
신학기를 맞아 KARA 정기 세미나를 다시 시작합니다!
많은 관심과 참여 부탁드립니다! 😆 

[22nd KARA Research Seminar]
- 일자: 1월 22일 (목)
- 시간: 8:00 PM (ET) / 7:00 PM (CT) / 5:00 PM (PT)
- 연사: Ziwon Yoon (Ph.D. Student @ Georgia Tech)
- 제목: Humanoid outdoor navigation: review, current progress, and future direction
- 참여링크: https://lnkd.in/enEf4m6u
Abstract:
...
📢 KARA 제21회 정기 세미나를 안내드립니다!
많은 관심과 참여 부탁드립니다! 😆 
[21th KARA Research Seminar]
- 일자: 12월 11일 (목)
- 시간: 8:00 PM (ET) / 7:00 PM (CT) / 5:00 PM (PT)
- 연사: Jungpyo Lee (Postdoc @ UC Berkeley)
- 제목: Failure-Resilient Grasping Through Inherent Functionality: Autonomous and Assistive Perspectives
Abstract:
...
📢 KARA 제20회 정기 세미나를 안내드립니다!
이번 세미나는 인턴십에 대하여 토론하는 자리를 마련했습니다.
인턴십에 대해 알고싶으신 분, 인턴십 경험을 나누고 싶은신 분, 같이 모여서 이야기를 나누어 보아요! 😆 
[20th KARA Research Seminar]
- 일자: 11월 13일 (목)
- 시간: 8:00 PM (ET) / 7:00 PM (CT) / 5:00 PM (PT)
- 연사: Scott (Seongwon) Lee, Wonsuhk Jung, Mingyo Seo
- 제목: [Discussion Session] Paths to Graduate Internship

📢 KARA 제19회 정기 세미나를 안내드립니다!
많은 관심과 참여 부탁드립니다! 😆 
[19th KARA Research Seminar]
- 일자: 10월 30일 (목)
- 시간: 8:00 PM (ET) / 7:00 PM (CT) / 5:00 PM (PT)
- 연사: Seungeun (Ross) Rho (Ph.D. Student @ Georgia Tech)
- 제목: Scaling Unsupervised Skill Discovery with Guidance
Abstract: Unsupervised skill discovery aims to learn a diverse repertoire of behaviors through free interaction with the environment, without relying on any task-specific reward signals. While recent research has made notable progress, scaling these methods to high-degree-of-freedom agents or real-world systems remains highly challenging.
In this seminar, we will introduce three recent works addressing these challenges:
(1) LGSD – leveraging large language models (LLMs) to inject semantic guidance during skill discovery,
(2) SDAX – applying skill discovery to real-world legged robots, and
(3) RGSD – guiding skill discovery using reference data to enable scalable learning for high-dimensional agents.


📢 KARA 제18회 정기 세미나를 안내드립니다!
많은 관심과 참여 부탁드립니다! 😆 
[18th KARA Research Seminar]
- 일자: 10월 16일 (목)
- 시간: 8:00 PM (ET) / 7:00 PM (CT) / 5:00 PM (PT)
- 연사: Mingyo Seo (Ph.D. Student @ UT Austin)
- 제목: Sensorimotor Abstraction for Learning Generalizable Skills across Diverse Robots

📢 KARA 제17회 정기 세미나를 안내드립니다!
많은 관심과 참여 부탁드립니다! 😆 
[17th KARA Research Seminar]
- 일자: 10월 2일 (목)
- 시간: 8:00 PM (ET) / 7:00 PM (CT) / 5:00 PM (PT)
- 연사: Daeun Song (Postdoc @ George Mason Univ.)
- 제목: Socially and Contextually Aware Navigation for Robots in Human-Centric Environments
Abstract: Robots deployed in human-centric environments must navigate beyond geometric path planning, requiring awareness of context, social norms, and dynamic surroundings. They must navigate long distances without access to pre-built maps, while adapting to diverse terrains and environmental constraints that change over time. Also, the navigation further gets complicated by the need to respect human norms and respond to subtle, non-verbal cues such as gestures, posture, and head orientation. This talk presents recent advances that address these challenges. Together, these directions point toward navigation systems that are both robust to environmental complexity and sensitive to human presence, enabling robots to operate effectively in dynamic, real-world environments.

📢 KARA 제16회 정기 세미나를 안내드립니다!
많은 관심과 참여 부탁드립니다! 😆 
[16th KARA Research Seminar]
- 일자: 9월 18일 (목)
- 시간: 8:00 PM (ET) / 7:00 PM (CT) / 5:00 PM (PT)
- 연사: MJ (Minjae) Cho (PhD student @ UIUC)
- 제목: Control Contraction Metric-Guided Reinforcement Learning for Robust Path Tracking
Abstract: Control contraction metrics (CCMs)—positive-definite Riemannian metrics under which a closed-loop system is guaranteed to be incrementally exponentially stable—can be used to synthesize a contracting policy in path-tracking problems. However, the synthesized policy only ensures pointwise satisfaction of the CCM conditions and does not consider long-term optimality (i.e., cumulative tracking error) over the entire trajectory. Furthermore, this myopic approach may make the policy more susceptible to learning biases when approximate dynamics are used to formulate CCMs. To address these issues, we propose to integrate CCMs into reinforcement learning (RL), where CCMs provide dynamics-informed feedback for learning a contracting policy while RL gives a framework for minimizing cumulative tracking error under approximate dynamics. We show that our algorithm, contraction actor-critic (CAC), enhances path-tracking performance and remains robust under approximation errors of dynamics compared to relevant baselines. 



📢 KARA 제15회 정기 세미나를 안내드립니다!
📖 금번 세미나는 최근에 핫한 VLA관련 논문을 읽고 같이 토론하는 시간으로 준비했습니다. 많은 관심과 참여 부탁드립니다!
- 일자: 9월 4일 (목)
- 시간: 8:00 PM (ET) / 7:00 PM (CT) / 5:00 PM (PT)
Host: Dongho Kang
Open Discussion: Vision-Language-Action Models
Note: 이번 세미나에서는 자유롭게 VLA에 대해 토론해보려고 해요. 일단 아래 다섯 페이퍼를 골라봤는데요, I 번과 II-1~II.4 중에서 한 편씩 두 개를 읽고 이야기하면 좋을 것 같습니다.
I. Foundation Models in Robotics: Applications, Challenges, and the Future [link: https://arxiv.org/abs/2312.07843]
II-1. π0: A Vision-Language-Action Flow Model for General Robot Control [link: https://arxiv.org/abs/2410.24164]
II-2. GR00T N1: An Open Foundation Model for Generalist Humanoid Robots [link: https://arxiv.org/abs/2503.14734]
II-3. Gemini Robotics: Bringing AI into the Physical World [link: https://arxiv.org/abs/2503.20020]
II-4. A Careful Examination of Large Behavior Models for Multitask Dexterous Manipulation [link: https://arxiv.org/abs/2507.05331]

KARA의 이번 가을학기 첫 행사인, 제 14회 정기 세미나가 "오늘" 열립니다! 🎉 
많은 관심과 참여 부탁드립니다!
[14th KARA Research Seminar]
- 일자: 8월 21일 (목)
- 시간: 8:00 PM (ET) / 7:00 PM (CT) / 5:00 PM (PT)
- 연사: Won Dong Shin (Assistant Professor at POSTECH)
- 제목: Fast Ground-to-Air Transition Enabled by Avian-Inspired Multifunctional Legs
...
안녕하세요, KARA 제13회 정기 세미나를 안내드려요.
일자: 7월 24일 (목) 
시간: 8:00PM-9:30PM ET (7:00PM-8:30PM CT, 5:00PM-6:30PM PT)
Presenter: Hojoon Son
...
안녕하세요, KARA 제12회 정기 세미나를 안내드려요.
일자: 7월 10일 (목)
시간: 8:00PM-9:30PM ET (7:00PM-8:30PM CT, 5:00PM-6:30PM PT)
Presenter: Seungchan Kim
Title: Toward Real-Time Open-Vocabulary Semantic Mapping for Outdoor Robot Navigation
Abstract: Open-vocabulary semantic mapping is crucial for robots to understand diverse semantic concepts about objects and scenes beyond fixed label sets, enabling more flexible and intelligent decision-making in downstream tasks such as navigation. In this talk, I will first provide an overview of recent trends in open-vocabulary semantic mapping, and then highlight several key challenges that arise in outdoor settings. Second, I will introduce RayFronts, an open-vocabulary semantic mapping system that captures semantics of far-range objects and achieves fine-grained vision-language alignment. Finally, I will discuss how this approach can be extended and adapted to enhance real-time robot navigation in complex outdoor environments.

안녕하세요, KARA 제11회 정기 세미나를 안내드려요.
일자: 6월 26일 (목) 시간: 8:00PM-9:30PM ET (7:00PM-8:30PM CT, 5:00PM-6:30PM PT)
Presenter: Yunwoo Lee
...
안녕하세요, KARA 제2회 정기 세미나를 안내드려요.
일자: 2월 20일 (목)
시간: 8:00PM-9:30PM ET (7:00PM-8:30PM CT, 5:00PM-6:30PM PT)
Presenter #1: Dongho Kang
Title: Design of Anthropomorphic Humanoid Robot for Whole Body Manipulation
...
Presenter #2: Yoonchang Sung
Title: Extending Current Capabilities of Task and Motion Planning